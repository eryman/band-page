...
module.controller('MainController', function($scope, myService) {
    myService.getData().then(function(data) {
      ...
      // ABOUT
        ...
        $scope.band_members = splitTextBlock(data.band_members);
        $scope.artists_we_like = splitTextBlock(data.artists_we_like);
        $scope.band_interests = splitTextBlock(data.band_interests);
        $scope.general_info = splitTextBlock(data.general_info);
        $scope.hometown = data.hometown;
        $scope.influences = splitTextBlock(data.influences);
        $scope.record_label = data.record_label;
      // CONTACT
